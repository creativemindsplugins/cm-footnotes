...
$config = [
    ...
    'settings' => [
        ...
        'cmf_add_definitions_with_shortcode_only'           => [
            'type'        => TYPE_CUSTOM,
            'value'       => '',
            'tab'         => 0,
            'section'     => 0,
            'label'       => __('Display footnote definitions by shortcode', 'cmf'),
            'description' => __('Select if you want to prevent automatically adding definitions to the bottom of the page and use the [cm_footnotes_definition_box] shortcode to add a definition box.', 'cmf'),
            'onlyin'      => 'Pro'
        ],
        'cmf_disable_highlighting_selected_footnote'           => [
            'type'        => TYPE_CUSTOM,
            'value'       => '',
            'tab'         => 0,
            'section'     => 0,
            'label'       => __('Disable highlighting footnotes', 'cmf'),
            'description' => __('Select if you want to prevent automatically highlighting footnotes by clicking.', 'cmf'),
            'onlyin'      => 'Pro'
        ],
        'cmf_delay_before_scroll_to_footnote'           => [
            'type'        => TYPE_CUSTOM,
            'value'       => '',
            'tab'         => 0,
            'section'     => 0,
            'label'       => __('Delay before scrolling to footnotes definition', 'cmf'),
            'description' => __('Set the delay before scrolling to the footnotes definition, and set 0 to disable the delay.', 'cmf'),
            'onlyin'      => 'Pro'
        ],
        ...
        'cmf_footnoteDescriptionIndent'                   => [
            'type'        => TYPE_CUSTOM,
            'value'       => '',
            'tab'         => 0,
            'section'     => 2,
            'label'       => __('Indentation', 'cmf'),
            'description' => __('', 'cmf'),
            'onlyin'      => 'Pro'
        ],
        ...
        'cmf_footnotebacklink_separator'              => [
            'type'        => TYPE_CUSTOM,
            'value'       => '',
            'tab'         => 0,
            'section'     => 2,
            'html'        => '',
            'label'       => __('Backlink style', 'cmf'),
            'description' => __('Select this options to display a custom backlink styles.', 'cmf'),
        ],
        'cmf_footnoteBacklinkPosition'           => [
            'type'        => TYPE_CUSTOM,
            'value'       => '',
            'tab'         => 0,
            'section'     => 2,
            'options'     => ['before' => 'Before definition', 'after' => 'After definition'],
            'label'       => __('Position', 'cmf'),
            'description' => __('', 'cmf'),
            'onlyin'      => 'Pro'
        ],
        'cmf_footnoteBacklinkColor'           => [
            'type'        => TYPE_CUSTOM,
            'value'       => '',
            'tab'         => 0,
            'section'     => 2,
        ...
        'cmf_footnoteBacklinkSymbol'           => [
            'type'        => TYPE_CUSTOM,
            'value'       => '',
            'tab'         => 0,
            'section'     => 2,
            'label'       => __('Symbol', 'cmf'),
            'description' => __('Enter the symbol you would like to use for the backlink.', 'cmf'),
            'onlyin'      => 'Pro'
        ],
        ...
        'cmf_footnoteExtlink_separator'              => [
            'type'        => TYPE_CUSTOM,
            'value'       => '',
            'tab'         => 0,
            'section'     => 2,
            'html'        => '',
            'label'       => __('External link style', 'cmf'),
            'description' => __('Set the style of footnote external link.', 'cmf'),
        ],
        'cmf_footnoteExtlinkSize'            => [
            'type'        => TYPE_CUSTOM,
            'value'       => '',
            'tab'         => 0,
            'section'     => 2,
